  ...
  return _createClass(Node, [{
    ...
    value: function positionBy(opts) {
      ...
      if (opts.index) {
        ...
        var stringRepresentation = this.source.input.document.slice(sourceOffset(this.source.input.document, this.source.start), sourceOffset(this.source.input.document, this.source.end));
    ...
    value: function positionInside(index) {
      ...
      var offset = sourceOffset(this.source.input.document, this.source.start);
